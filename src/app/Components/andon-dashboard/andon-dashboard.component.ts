...
@Component({
  selector: 'app-andon-dashboard',
  templateUrl: './andon-dashboard.component.html',
  styleUrls: ['./andon-dashboard.component.scss']
})
export class AndonDashboardComponent implements OnInit {
  count_machine:any;
  a_dashboard:any; 
  valuen:any; 
  data:any;
